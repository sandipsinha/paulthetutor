...
put_ptts_header("View Current Classes for Paul The Tutor's", $strAbsPath, "admin", "");
$order = $_REQUEST['order'];
$sort = $_REQUEST['sort'];
$move_id = $_REQUEST['move_id'];
$tablename = "PT_SAT_Class_Info";
if ($sort == "")
	$sort = "id";
if($order==""){
	$order="DESC";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
  	<td align="right" style="padding-bottom:5px"><button onclick="javascript:popup('class_edit.php?popup=popup','Class Edit','600','800')"> Add a Class</button></td>
  </tr>
  <tr height="40">
  ...
  <table border=1 width="100%" cellpadding="3" cellspacing="0" class="table_1" align="center">
...
while($row = mysql_fetch_array($RS)){
	$start_date = format_date_print($row[start_date],"yy-mm-dd", $separator = "-","mm-dd-yy","-");
	$end_date = format_date_print($row[end_date],"yy-mm-dd","-","mm-dd-yy","-");
 		...
 		<td nowrap  align=center>
			<a onclick="javascript:popup(\'class_view.php?popup=popup&id='.$row[id].'\',\'View Comment\',\'600\',\'600\')"><img SRC="../images/view.gif" ALT="view" title="view" border="0"></a>&nbsp;
			<a href="class_edit.php?id='.$row[id].'"><img SRC="../images/edit_pencil.gif" ALT="edit" border="0"></a>&nbsp;
			
			<a onclick="javascript:popup(\'class_student_edit.php?tab=PT_TestPrep_Reg\',\'Add a Student\',\'600\',\'600\')"><img SRC="../images/add_user3.png" ALT="Add a Student" title="Add a Student" border="0"></a>&nbsp;

			<a target=_blank href="view_rosters.php?class='.$row[id].'"><img SRC="../images/roster_users1.png" ALT="View Roster" title="Roster" border="0"></a>&nbsp;
