...
if($_REQUEST[man_rp] == 'checked')
	...
	$msg = sri_session_add($_add_date,$_REQUEST[location_id],$_REQUEST[student_id],$tutor_id,$_start_time,$_REQUEST[hours],$_REQUEST[name],$sched_id,$_REQUEST[comments],$_REQUEST[name],$_REQUEST[rate],$_REQUEST[pay],$opts);
...
//		putSelectInput('Tutor<font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;', 'tid', $arr_tutors, '', '', '','Choose a Tutor');
	...
	putTextField("Date<font color='#FF0000'>*</font>&nbsp;&nbsp;", "date", 11, 11, ($arFieldVal['date'] ? $arFieldVal['date'] : $_REQUEST['date']),'','',$date_spec);
