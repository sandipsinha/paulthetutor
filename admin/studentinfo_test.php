...
<script type="text/javascript">
  ...
  function DynamicFilter(text) {
    ...
    $('tr.studentList').each(function() {
      if ($(this).attr("class") != "studentHeader") {
...
<div colspan=8 class='Filter' width='125px'>Search: 
            <form name=form method="post">
              <input type="submit" style="display:none">
              <input type="Text" id="filterInput" onsubmit="return(false);">
            </form>
</div>
<form name=form method="post">
  <input type="submit" style="display:none">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <?php }?>
  <tr style="background: #eee; height: 35px" class="studentHeader">
...
while($row = mysql_fetch_array($RS)){
 ...
 echo '<tr class="studentList">
 		...
 		echo '<td nowrap  align=center><a onclick="popup(\'student_view.php?id='.$row['id'].'\',\'\',600,700)"><img SRC="../images/view.gif" ALT="view" border="0"></a>&nbsp;
 			<a onclick="popup(\'student_edit.php?id='.$row['id'].'\',\'\',600,700)"><img SRC="../images/edit_pencil.gif" ALT="edit" border="0"></a>&nbsp;
 			<a href="#void" onclick="if (confirm(\'Are you sure you want to archive this student?\')) {document.form.move_id.value='.$row['id'].'; document.form.submit()}"><img SRC="../images/del_x.gif" ALT="archive" border="0"></a>&nbsp;</td>';
 echo '</tr>';
}
