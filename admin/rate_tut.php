...
$QStr = "select id, (select short_name from PT_Locations as l where l.id = r.location_id) as location  ,(select CONCAT(first_name, LEFT(last_name, 2)) from PT_Tutors where PT_Tutors.id = r.tutor_id) as tutor, rate, pay  from $tablename as r $where $sortby";
$rs = runquery($QStr);
