...
<script>
    $(document).ready(function(){
        $("#student_input").autocomplete("autocomplete_student.php", {
               selectFirst: true
        });
		
		 $("#student_input").result(function(event, data, formatted) {
			
	        $("#student_menu_student_id").val(data[1]);
    });
    });
</script>
<?php
...
<div style="padding:10px"><table cellspacing="0" cellpadding="0" border="3">
<TR>
<TD>
<div align="right">Student&nbsp;&nbsp;</div>
</TD>
<TD>
    <input name="student_input" type="text" id="student_input" size="60"/>
</TD>
</TR>
