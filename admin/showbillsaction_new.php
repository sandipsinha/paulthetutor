...
<? } ?>        
        ...
        <a target=_blank class="a_white"  style="font-size:13px" href="allbills_action.php?fid=<?php echo $arSInfo[fid] ?>">All Months</a>&nbsp;&nbsp;&nbsp;<a target=_blank class="a_white"  style="font-size:13px" href="billinghistory_action.php?fid=<?php echo $arSInfo[fid] ?>">Billing History</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
if ($count ==0){
  echo "<center><b> No Students enrolment found for $month- $year </b></center>";
  }
?>
</form>
<?php
    //echo 'The folder is ' . $folder . ' nd ' . $_REQUEST["not_mothh_view"];
if ((!$_REQUEST["not_mothh_view"]) and ($folder <> "tutors"))
    //echo ' going to month overview'. ' And '. $tid . ' And '. $month . ' And ' . $year;
