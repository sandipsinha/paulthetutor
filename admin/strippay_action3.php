...
if($son <> "on"){
	...
	if($folder == "admin")
		header( "Location: https://www.paulthetutors.com/admin/strippay_action3.php");
...
if($folder == "parents"){
	...
	if($saved >=1){
		header( "Location: https://www.paulthetutors.com/parents/strip_saved_charge2.php");
	}
}
...
<table width="100%" bgcolor="#FFFFFF">
        ...
        <form action="strippay_process4.php" method="POST" id="payment-form">
		    <div class="form-row">
                <tr><td width="32%" align="right">Account Number: </td><td width="68%">
...
<a href="viewbill.php" target="_blank" class="form_comments">See Billing Info</a><? } // parents	

if($folder == "ccpay"){ ?>

<a href="../parents/viewbill.php" target="_blank" class="form_comments">See Billing Info</a><? } // ccpay ?>		
...
<? if($folder == "not exist yet"){ ?>
 
            <div class="form-row">
                <tr>
                  <td align="right">store my credit card infomation </td><td>
                  <input name="store" type="checkbox" id="store" value="1"></td>
                </tr>
            </div>
            <div class="form-row">
                <tr>
                    <td align="right">enroll me inmonthy autopay <br />
                  <span class="form_comments">Receive $10/hr discount</span></td><td>
                  <input name="autopay" type="checkbox" id="autopay" value="1"> <span class="form_comments">(<a href="autopay_explain.php" target="_blank">How does autopay work?</a>)</span></td>
                </tr>
            </div>
	<? } ?>	
