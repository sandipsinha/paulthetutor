...
<? }  ?>            
        ...
        <!-- Added by Sandip on 10/29/14 to fix invalid link for adding a session - Begin-->
          <td><span style="font-weight:bold">Scheduling -</span> <a href="calendar.php" style="font-weight:bold">Calendar</a> - <a href="addsess_loc.php" style="font-weight:bold">Add
