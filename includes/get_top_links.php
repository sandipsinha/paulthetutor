...
function get_top_links2( $folder ) {
    ...
    case "admin":
        ...
        **/
		...
		//Added by Sandip on 10/27/14 Issue # 53A  Begin
        $communication->addDropDownLink( $folder, "Potential Students", "new_ce.php" );
		//Added by Sandip on 10/27/14 Issue # 53A  End
        ...
        **/
        ...
        $month = date( strtotime("-60 days") ); //date( "Y-m" ) . "-00";
        ...
        **/        
        ...
        $accounting->addDropDownLink( $folder, "Month Overview", FULL_BASE_PATH."/admin/monthoverview.php" );
        ...
        **/
        ...
        $billing->addDropDownLink( $folder, "Show", FULL_BASE_PATH."/admin/showbills_new.php" );
        ...
        Families
            ...
            Rates for Families
        **/
        $families = new Uplinks( $folder, 6, 0, "Families", "#" );
        $families->addDropDownLink( $folder, "Families", FULL_BASE_PATH."/admin/families.php" );
        ...
        **/
        ...
        Tutors
            ...
            Interview Manager?
        **/
		//Added by Sandip on 10/08/14  -Begin
		$tutors = new Uplinks( $folder, 8, 0, "Tutors", "#" );
        //$tutors = new Uplinks( $folder, 8, 0, "Tutors", FULL_BASE_PATH."/admin/tutorsinfo.php" );
		$tutors->addDropDownLink( $folder, "Tutor Info", FULL_BASE_PATH."/admin/tutorsinfo.php" );
		//  New code added by Sandip End
    ...
    case "parents":
        ...
        **/
        ...
        $tutors_notes->addDropDownLink( $folder, "Tutor's Info", "tutorsinfo.php" );
