...
*/
require_once 'Extension/Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once 'Extension/Author.php';

/**
 * @see Zend_Gdata_App_Extension_Category
*/
require_once 'Extension/Category.php';

/**
 * @see Zend_Gdata_App_Extension_Contributor
*/
require_once 'Extension/Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once 'Extension/Id.php';

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once 'Extension/Link.php';

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once 'Extension/Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once 'Extension/Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once 'Extension/Updated.php';
