<?php
include(" /home/paulthetutor/paulthetutors.com/includes/pttec_includes.phtml");
...
$SQS = "select id, student_name from PT_TestPrep_Reg where class = 1 and archived = 0 order by student_name";
SelectFromQuery($SQS, 'Select Student', 'sat_id', '', '', '', '', '');
?>
<tr>
