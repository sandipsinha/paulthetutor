...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
      <td align="right" style="padding-bottom:5px"><button onclick="javascript:popup('gethwsum_test.php?class_id=<?=$class_id?>&popup=1','Details','600','600')" style="cursor:pointer">Add New Homework</button></td>
  </tr>
  <tr height="40">
...
while($row = mysql_fetch_array($RS)){
 echo '<tr>
         ...
         <td nowrap  align=center>
	             <a onclick="javascript:popup(\'gethwsum_test.php?id='.$row[id].'&student_id='.$row[student_id].'&popup=1\',\'Details\',\'600\',\'600\')"><img SRC="'.$strAbsImgPath.'edit_pencil.gif" ALT="edit" border="0"></a>&nbsp;
