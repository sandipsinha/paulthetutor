...
put_ptts_header("ACT Results", $strAbsPath, "", "");


printarray($_REQUEST);
$strTableName = "TP_ACT_Answers";
$test_id = $_REQUEST[test_id];
$section_num = $_REQUEST[section_num];
$section_id = singlequery("select id from TP_SAT_Sections where test_id = $test_id and section_num = $section_num");
