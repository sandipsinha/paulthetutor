...
<td height ="100" align="center">
 ...
 <br><table border="0" cellpadding="5" margin="0" align="center" cellspacing="0" bgcolor="#FFFFFF" class="table_1">   
...
//show the section for the student
	foreach( $sections as $section_id => $sec_num){
		...
		show_test_sec($student_id, $section_id, $link );
...
?>  Section: <input name="section_num" type="text" value="<?=$section_info[section_num];?>" size="2" maxlength="2" />
...
?>
<br />
<a href="http://www.paulthetutors.com/ldsatprep/students/ans_grader.php?test_id=<?$test_id;?>" target="_parent">Student Link to Results </a><br />
