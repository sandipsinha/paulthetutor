...
<table width="100%" border="0" cellpadding="7" cellspacing="0" style="border:solid 1px #999">
  <tr height="40">
    <td class="td_header">Homework results for <?=$row_student[student_name]." on ".$row_test[name]." , section ".$section?></td>
  </tr>
...
$QStr = "select * from $strTableName a WHERE testprep_id='".$sat_id."' AND testprep_id='".$sat_id."' AND class_id='".$class_id."' AND test_id='".$test_id."' AND section_num='".$section."' order by problem";
$RS = runquery($QStr);
