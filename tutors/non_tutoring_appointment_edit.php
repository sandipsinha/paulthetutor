...
putSelectInput('Dow<font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;', 'day_of_week', $arr_days, $arFieldsVals['day_of_week'], '', '','');

?>
<tr>
	<td colspan="2">
<?
	MySQL_JustForm($strTableName, $arFieldNames, $arFieldsVals, $arFieldComments, $arHidden, $strNotUsed, $formName, '', 1);
?>
</td>
</tr>
